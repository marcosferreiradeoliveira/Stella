          ...
          <IntroSection
            ...
            textContent={
              <>
                ...
                <p>Embora tenha falecido em 1992, sem jamais ter saído da Colônia Juliano Moreira, seu Falatório segue ecoando e inspirando artistas, pesquisadores e movimentos sociais. Em 2001, foi publicado o livro Reino dos bichos e dos animais é o meu nome, organizado por Viviane Mosé. Embora a instituição literária tenha trazido visibilidade para o Falatório, são os estudos recentes, como os de Ariadne Catarine dos Santos, Anna Carolina Zacharias, Bruna Beber e Sara Ramos, que nos convocam e provocam rumo a uma escuta atenta, ética e politicamente inserida no contexto sociocultural brasileiro. 
                </p>

                <p className="audio-link">
                  <a 
                    href="https://dspace.unila.edu.br/items/84d91349-d213-425f-975d-3d2da6e12b7c" 
                    target="_blank" 
                    rel="noopener noreferrer"
                  >
                    Ouça os áudios na íntegra clicando aqui
                  </a>
                </p>
              </>
            }
...
E agora eu vivo no hospital como doente."
            ...
            image={Cartaz10}
            audio=""
            footnotes={"SOUZA, Mônica. VERSOS, REVERSOS, pensamentos e algo mais..., 1991. Acervo do Museu Bispo do Rosário Arte Contemporânea."}
            poem={[
          ...
          <PageSection
            ...
            textContent={
              <>
                ...
                <blockquote>
                  "Eu sou seguida, acompanhada, imitada, assemelhada, tomada conta, fiscalizada, examinada, revistada. Tem esses que são iguaizinho a mim, tem esses que se veste se calça igual a mim, mas que são diferente... da diferença entre nós. É tudo bom e nada presta."
                </blockquote>
...
"
          ...
          <PageSection
            ...
            textContent={
              <>
                ...
                <p>Esculpindo uma dicotomia, Stella parece querer afastar qualquer ideia de sonho do seu cotidiano no manicômio. Descrita a partir dos elementos no espaço, não à toa, essa realidade que a circunda não deixa espaço para o sonhar, nem mesmo para a memória do que nasce no inconsciente.</p>
        ...
        <Element name="eight">
          <PageSection
            ...
            image={Cartaz3}
            audio={Audio2}
            footnotes="* SIMAS, Luiz Antonio. A cidade de St ella do Patrocínio: a vadiagem como estratégia de resistência. In: ZACHARIAS, Anna Carolina (Org.). Stella do Patrocínio: entre a letra e a negra garganta de carne. Rio de Janeiro: Museu Bispo do Rosário Arte Contemporânea, 2022. p. 11-24."
      ...
      <div className="section-content">
        ...
        <div className="content-flex">
          <div className="left-content">
            ...
            <a 
              href="https://drive.google.com/file/d/1-zh2nAsfz_dcMcjklmXAsIlhe38loGp_/view?usp=sharing" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="accessibility-btn"
            >
