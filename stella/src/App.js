            ...
            <>
              <div className="left-content">
                ...
                <div className="audio-section">
                  <h3 className="section-title" style={{fontFamily: 'Unit Slab, sans-serif'}}>Ouça o trecho</h3>
                  <audio controls>
                    <source src="./assets/audio/trecho.mp3" type="audio/mpeg" />
                    Seu navegador não suporta o elemento de áudio.
                  </audio>
                </div>
                <div className="map-container">
                  <h3 className="section-title" style={{fontFamily: 'Unit Slab, sans-serif'}}>Onde encontrar o cartaz</h3>
                  <iframe 
                ...
                <div className="accessibility-section">
                  <h3 className="section-title" style={{fontFamily: 'Unit Slab, sans-serif'}}>Acessibilidade</h3>
